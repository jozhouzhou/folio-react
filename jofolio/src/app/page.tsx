		...
		<div className="flex flex-col items-center px-8 lg:px-48 lg:my-24">
			...
			<div className="flex flex-col w-full justify-between space-y-12 px-12 mb-20 lg:mb-36 lg:flex-row lg:space-y-0 lg:space-x-12">
				...
				<div className="flex flex-col w-full justify-start lg:w-1/3">
					...
					<h2 className="text-sm mb-3 text-nowrap lg:mb-3 lg:text-xl">Usable App Design</h2>

					<p className="text-[#5F5F5F] text-xs leading-tight lg:text-[16px]">Designing interfaces that are intuitive, efficient, and enjoyable to use.</p>
				...
				<div className="flex flex-col w-full justify-start lg:w-1/3">
					...
					<h2 className="text-sm mb-3 text-nowrap lg:mb-3 lg:text-xl">Responsive Web Design</h2>

					<p className="text-[#5F5F5F] text-xs leading-tight lg:text-[16px]">Transforming ideas into exceptional web and mobile app experiences.</p>
				...
				<div className="flex flex-col w-full justify-start lg:w-1/3">
					...
					<h2 className="text-sm mb-3 text-nowrap lg:mb-3 lg:text-xl">Developer-Friendly Prototypes</h2>

					<p className="text-[#5F5F5F] text-xs leading-tight lg:text-[16px]">Crafting visually stunning designs that connect with your
					audience.</p>
