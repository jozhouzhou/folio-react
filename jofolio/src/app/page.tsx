...
function Hero() {
	return (
		...
		<div className="flex flex-col bg-background rounded-b-[72px] items-center pt-12 pb-16 lg:pb-14">
			...
			{/* button */}
			<a href="https://www.google.com" className="cursor-pointer rounded-full bg-foreground border-white border drop-shadow-sm text-white text-[13px] transition duration-250 ease-out hover:bg-white [&>*:first-child]:hover:text-foreground [&>*:first-child]:[&>*:first-child]:hover:fill-foreground px-8 py-3 lg:py-4 lg:text-base">
...
function ServicesList() {
	return (
		...
		<div className="flex flex-col items-center px-8 lg:px-48 lg:my-24">
			...
			{/* section title */}
			<h1 className="rounded-full bg-white -rotate-[20deg] border-background border drop-shadow-md text-sm mb-8  px-6 py-2 lg:mb-24 lg:text-base">Services</h1>

			{/* services list */}
			<div className="flex flex-col w-full justify-between space-y-12 px-12 mb-20 lg:mb-36 lg:flex-row lg:space-y-0 lg:space-x-12">

				{/* service 1 */}
				<div className="flex flex-col w-full justify-start lg:w-1/3">
				
					<svg className="mb-3 w-[32px] h-[24px] lg:w-[59px] lg:h-[44px]" viewBox="0 0 59 44" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<h2 className="text-sm mb-3 lg:mb-3 lg:text-xl">Usable App Design</h2>

					<p className="text-[#5F5F5F] text-xs lg:text-[16px]">Designing interfaces that are intuitive, efficient, and enjoyable to use.</p>
				...
				<div className="flex flex-col w-full justify-start lg:w-1/3">
					...
					<svg className="mb-3 w-[44px] h-[24px] lg:w-[79px] lg:h-[44px]" viewBox="0 0 79 44" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<h2 className="text-sm mb-3 lg:mb-3 lg:text-xl">Responsive Web Design</h2>

					<p className="text-[#5F5F5F] text-xs lg:text-[16px]">Transforming ideas into exceptional web and mobile app experiences.</p>
				...
				<div className="flex flex-col w-full justify-start lg:w-1/3">
					...
					<svg className="mb-3 w-[31px] h-[24px] lg:w-[55px] lg:h-[44px]" viewBox="0 0 55 44" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<h2 className="text-sm mb-3 lg:mb-3 lg:text-xl">Developer-Friendly Prototypes</h2>

					<p className="text-[#5F5F5F] text-xs lg:text-[16px]">Crafting visually stunning designs that connect with your
					audience.</p>
