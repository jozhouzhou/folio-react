...
export default function LandingSkillCard({ skillNumber }: LandingSkillCardProps) {
	...
	return (
        <div className="flex flex-col rounded-r-xl items-center text-center bg-primary bg-opacity-5 
			hover:bg-opacity-15 duration-150 border-l-4 border-primary px-6 py-2 md:py-4 lg:rounded-r-3xl xl:py-10">
