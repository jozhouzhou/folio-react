...
export default function LandingSkillCard({ skillNumber }: LandingSkillCardProps) {
	...
	return (
        <div className="flex flex-col rounded-r-3xl text-center bg-primary bg-opacity-5 border-l-4 border-primary px-6 py-10">
          	
			<div className="flex w-1/5 aspect-square mb-6 mx-auto items-center justify-center p-2">
