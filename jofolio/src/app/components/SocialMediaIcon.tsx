...
export default function SocialMediaIcon({ platform }: SocialMediaIconProps) {
	...
	const data = [
		...
		},
		{
			...
			viewbox: '0 0 448 512',
			link: 'https://www.au.linkedin.com',
		},
		{
	...
	return (
		<div>
			<a href={data[platform].link} type="button"
        		className="flex rounded-full bg-transparent p-3 transition duration-150 ease-in-out hover:bg-primary hover:text-footer text-white dark:hover:bg-secondary-900">
        		
				<span className="[&>svg]:h-5 [&>svg]:w-5">
          			<svg fill="currentColor" viewBox={data[platform].viewbox}>
            			<path d={data[platform].icon} />
          			</svg>
				</span>
      		</a>
		</div>
