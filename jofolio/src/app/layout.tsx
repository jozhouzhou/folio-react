	...
	return (
		...
		<div className="flex flex-row justify-between items-center bg-background py-8 px-8 lg:px-36">
			...
			<div className="flex items-center justify-start lg:space-x-4">
				...
				<a href="/resume" className="cursor-pointer rounded-full text-base bg-foreground border-white border drop-shadow-sm transition duration-250 ease-out hover:bg-white [&>*:first-child]:hover:fill-foreground py-4 px-10 mr-2 lg:m-0 lg:p-0 lg:hidden">
				...
				{/* resume button */}
				<a href="/resume" className="cursor-pointer rounded-full text-base bg-white border-background border drop-shadow-sm transition duration-250 ease-out hover:bg-foreground [&>*:first-child]:hover:text-white [&>*:first-child]:[&>*:first-child]:hover:stroke-white py-4 px-10 lg:px-8 lg:py-4">
...
function Footer() {
  return (
    <div className="flex flex-col items-center rounded-t-[70px] lg:rounded-t-[100px] bg-background pt-20 lg:pt-40">
		...
		{/* footer title */}
		<h1 className="text-center text-3xl font-bold bg-gradient-to-r from-[#373737]  via-[#373737] via-70% to-[#9D9D9D] text-transparent bg-clip-text py-8 lg:text-5xl">Tell me about your next project</h1>
